...
class ProfessionalOtpVerifyWithEmailPage extends StatefulWidget {
  final String password;
  final String email;
  final UserProfile? userProfile;
  const ProfessionalOtpVerifyWithEmailPage({
    Key? key,
    required this.email,
  ...
  @override
  State<ProfessionalOtpVerifyWithEmailPage> createState() =>
      _ProfessionalOtpVerifyWithEmailPageState();
}

class _ProfessionalOtpVerifyWithEmailPageState
    extends State<ProfessionalOtpVerifyWithEmailPage> {
