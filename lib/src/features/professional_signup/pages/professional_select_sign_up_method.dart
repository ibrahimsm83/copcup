...
class ProfessionalSelectSignUpMethod extends StatefulWidget {
  final UserProfile professional;
  final String password;
  const ProfessionalSelectSignUpMethod({
    super.key,
  ...
  @override
  State<ProfessionalSelectSignUpMethod> createState() =>
      _SelectSignUpMethodState();
}

class _SelectSignUpMethodState extends State<ProfessionalSelectSignUpMethod> {
  Future registerUser(String number) async {
    FirebaseAuth _auth = FirebaseAuth.instance;

    _auth.verifyPhoneNumber(
      phoneNumber: widget.professional.phonenumber,
      ...
      codeSent: (verificationId, forceResendingToken) {
        context.goNamed(AppRoute.professionalOtpWithPhonePage, extra: {
          'email': widget.professional.email,
          'userProfile': widget.professional,
          ...
          child: Column(
            ...
            children: [
              ...
              _contactOption(
                ...
                hintText: widget.professional.email,
              ...
              _contactOption(
                ...
                controller: provider.phoneController
                  ..text = widget.professional.phonenumber,
                hintText: widget.professional.phonenumber,
                    ...
                    try {
                      ...
                      if (provider.selectedOption == 'email') {
                        await authcontroller.registerUser(
                          ...
                          onSuccess: (message) {
                            context.goNamed(
                              AppRoute.ProfessionalOtpWithEmailPage,
                              extra: {
                                'email': widget.professional.email,
                                'userProfile': widget.professional,
                                'password': widget.password,
                          ...
                          surname: widget.professional.surname,
                          email: widget.professional.email,
                          password: widget.password,
                          contactNumber: widget.professional.phonenumber,
                          countryCode:
                              widget.professional.countryCode.toString(),
                        );
                        log('password is ${widget.password}');
                        ...
                        registerUser(widget.professional.phonenumber);
                        overlay.hide();
                        showSnackbar(
