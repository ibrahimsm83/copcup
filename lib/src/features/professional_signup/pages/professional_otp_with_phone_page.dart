...
class ProfessionalOtpVerifyWithPhonePage extends StatefulWidget {
  final String password;
  final String email;
  final UserProfile? userProfile;
  const ProfessionalOtpVerifyWithPhonePage({
    super.key,
    required this.email,
  ...
  @override
  State<ProfessionalOtpVerifyWithPhonePage> createState() =>
      ProfessionalOtpVerifyWithPhonePageState();
}

class ProfessionalOtpVerifyWithPhonePageState
    extends State<ProfessionalOtpVerifyWithPhonePage> {
