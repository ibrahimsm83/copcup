...
class ResponsibleChangePassword extends StatefulWidget {
  const ResponsibleChangePassword({super.key});

  @override
  State<ResponsibleChangePassword> createState() =>
      ResponsibleChangePasswordState();
}

class ResponsibleChangePasswordState extends State<ResponsibleChangePassword> {
  @override
  ...
  List<Widget> page = [
    ...
    Consumer<ResponsibleHomeProvider>(
        builder: (context, value, child) => value.resChangePassword
            ? ResponsibleChangePasswordPageWidget()
            : ResponsibleProfilePage()),
  ];
}

class ResponsibleChangePasswordPageWidget extends StatelessWidget {
  ResponsibleChangePasswordPageWidget({super.key});
