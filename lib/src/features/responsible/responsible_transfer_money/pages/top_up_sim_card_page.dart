...
class TopUpSimCardPage extends StatelessWidget {
  TopUpSimCardPage({super.key});
          ...
          child: Column(
            ...
            children: [
              TransfeMoneyWidget(
                ...
                amountText: 'Mobile Phone No.',
              ),
              Consumer<ResponsibleTransferProvider>(
                builder: (context, value, child) => TextFormField(
                  controller: mobileNumController,
                  onChanged: (val) {
                    value.updatePhoneNumberValidation(val);
                  },
                  ...
                  validator: (validator) {
                    ...
                    } else if (!value.phoneNumberValidation
                        .hasMatch(validator)) {
                  ...
                  decoration: InputDecoration(
                      ...
                      suffixIcon: value.phoneNumbervalidate == false
                          ? SizedBox()
                          : Padding(
                ...
                child: TransferMoneyCustomButton(
                  ...
                  onTap: () {
                    if (_formKey.currentState!.validate()) {
                      context.pushNamed(AppRoute.topUpAmountPage);
                    }
                  },
                ),
              )
