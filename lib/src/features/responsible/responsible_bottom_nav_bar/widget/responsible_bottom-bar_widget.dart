...
class ResponsibleBottomBarWidget extends StatefulWidget {
  const ResponsibleBottomBarWidget({super.key});

  @override
  State<ResponsibleBottomBarWidget> createState() =>
      _ResponsibleBottomBarWidgetState();
}

class _ResponsibleBottomBarWidgetState
    extends State<ResponsibleBottomBarWidget> {
  @override
      ...
      return Column(
        children: [
          ...
          GestureDetector(
            ...
            onTap: () {
              navigationProvider.updateResponsibleBool(false);
              ...
              child: Consumer(
                builder: (context, value, child) => Row(
                  ...
                  children: [
                    ...
                    _buildNavBarItem(context, index: 2),
