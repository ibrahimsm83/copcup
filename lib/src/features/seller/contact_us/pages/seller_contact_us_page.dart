...
class SellerContactUsPage extends StatelessWidget {
  SellerContactUsPage({super.key});
  ...
  List<Widget> pages = [
    ...
    Consumer<SellerHomeProvider>(
        builder: (context, value, child) => value.sellerNatificationBool
            ? SellerContactUsWidget()
            : SellerSettingPage()),
  ];
}

class SellerContactUsWidget extends StatefulWidget {
  const SellerContactUsWidget({super.key});

  @override
  State<SellerContactUsWidget> createState() => _SellerContactUsWidgetState();
}

class _SellerContactUsWidgetState extends State<SellerContactUsWidget> {
  @override
  ...
  Widget build(BuildContext context) {
    ...
    final sellerprovider = Provider.of<SellerAuthController>(context);
    return Padding(
                  ...
                  onPressed: () async {
                    if (_formkey.currentState!.validate()) {
                      ...
                      await chatProvider.createChatRoom(
                          ...
                          name: sellerprovider.seller!.name,
                          members: [
                            sellerprovider.seller!.id,
                            1,
                          ],
                          type: 'private',
                          context: context);
