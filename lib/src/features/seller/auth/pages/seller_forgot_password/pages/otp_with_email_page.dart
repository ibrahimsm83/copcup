...
class SellerOtpWithEmailPage extends StatefulWidget {
  final String email;
  final String role;
  const SellerOtpWithEmailPage({
    super.key,
    required this.email,
    required this.role,
  });
  ...
  @override
  State<SellerOtpWithEmailPage> createState() => _SellerOtpWithEmailPageState();
}

class _SellerOtpWithEmailPageState extends State<SellerOtpWithEmailPage> {
                ...
                if (otpPin.length == 6) {
                  await authcontroller.verifyOtpforgotPassword(
                    ...
                    onSuccess: (message) {
                      ...
                      context.pushNamed(AppRoute.sellerResetPassword, extra: {
                        'email': widget.email,
                        'token': otpPin,
                        'role': widget.role
                      });
