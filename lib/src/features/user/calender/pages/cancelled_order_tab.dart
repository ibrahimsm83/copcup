...
//                                 children: [
//                                   Text(
//                                     '${order.orderItems.first.quantity} Items',
//                                     style: textTheme(context)
//                                         .bodySmall
//                                         ?.copyWith(
//                                             color:
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final firstOrderItem =
                  hasOrderItems ? order.orderItems.first : null;
              final foodItem = firstOrderItem?.foodItem;
